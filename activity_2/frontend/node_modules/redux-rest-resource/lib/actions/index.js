  ...
  return function (context) {
    ...
    return function (dispatch, getState) {
      ...
      var resolvedfetchOpts = Object.keys(fetchOpts).reduce(function (soFar, key) {
        soFar[key] = (0, _util.isFunction)(fetchOpts[key]) ? fetchOpts[key](getState, { context: context, contextOpts: contextOpts, actionId: actionId }) : fetchOpts[key];
        return soFar;
      }, {});
      ...
      return (0, _fetch2.default)(finalFetchUrl, finalFetchOpts).then((0, _transform.applyTransformPipeline)((0, _transform.buildTransformPipeline)(_defaults.defaultTransformResponsePipeline, actionOpts.transformResponse))).then(function (payload) {
        return dispatch(_extends({ type: type, status: 'resolved', context: context, options: reduceOpts, receivedAt: Date.now() }, payload));
      }).catch(function (err) {
        // Catch HttpErrors
        if (err.statusCode) {
          dispatch({
